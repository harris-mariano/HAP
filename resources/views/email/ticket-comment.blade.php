...
<div class="w-full p-10 flex flex-col justify-center items-center -mt-16">
    <div class="w-1/2 bg-custom-gray rounded-sm text-center flex flex-col gap-y-10 py-10 px-20">
        ...
        <p class="text-sm"><span class="font-medium">{{ $commenter }}</span> commented <span class="font-medium">{{ $comment }}</span>. </p>
        <a href="http://127.0.0.1:8000/tickets" class="bg-custom-orange text-white font-semibold text-sm p-2 rounded-sm">Reply in adish HAP</a>
