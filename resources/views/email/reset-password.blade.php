...
<div class="w-full p-10 flex flex-col justify-center items-center -mt-16">
    <div class="w-1/2 bg-custom-gray rounded-sm text-center flex flex-col gap-y-10 py-10 px-20">
        ...
        <p class="text-sm">Hello <span class="font-medium">{{ $name }}</span>, we are sending this email to you since you have requested to reset your password. </p>
        <p class="text-sm">If you did not request this action, please let us know by replying to this email.</p>
