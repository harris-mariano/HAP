@include('partials.header', ['title' => 'adish HAP | Ticket Assignment'])
...
<div class="w-full p-10 flex flex-col justify-center items-center -mt-16">
    <div class="w-1/2 bg-custom-gray rounded-sm text-center flex flex-col gap-y-10 py-10 px-20">
        <p class="font-semibold text-sm">Ticket Assignment</p>
        <p class="text-sm">Hello <span class="font-medium">{{ $name }}</span>, a ticket has been assigned to you named <span class="font-medium">{{ $title }}. </p>
        <p class="text-sm">Kindly review this ticket and update this by going through its ticket status, priority level and using discussions for any further concerns.</p>
