...
<div class="w-full p-10 flex flex-col justify-center items-center -mt-16">
    <div class="w-1/2 bg-custom-gray rounded-sm text-center flex flex-col gap-y-10 py-10 px-20">
        <p class="font-semibold text-sm">Thank you for registering at adish HAP!</p>
        <p class="text-sm">Hello <span class="font-medium">{{ $name }}</span>, this helpdesk app streamlines support tasks for teams, making it easy to address customer inquiries, resolve issues, and collaborate effectively for exceptional support experiences.</p>
        <p class="text-sm">By connecting your email, you will also receive notifications and updates about the ticket that you have created.</p>
