...
<body style="font-family: sans-serif; min-height: 100vh; display: flex;">
    <div style="width: 100%; padding: 2.5rem; display: flex; flex-direction: column; align-items: center;">
        <div style="width: 100%; border-radius: 0.25rem; display: flex; flex-direction: column; gap: 5px; padding: 2rem;">
            ...
            <p style="font-size: 0.875rem; font-weight:700;">Thank you for registering at adish HAP!</p>
            <p style="font-size: 0.875rem;">This helpdesk app streamlines support tasks for teams, making it easy to address customer inquiries, resolve issues, and collaborate effectively for exceptional support experiences.</p>
            <p style="font-size: 0.875rem;">By connecting your email, you will also receive notifications and updates about the ticket that you have created.</p>
