    ...
    <div class="bg-custom-gray w-full flex flex-col py-32 items-center gap-y-10">
        ...
        <div class="w-1/4">
            ...
            @csrf
                    ...
                    @enderror
                    <button id="loginButton" type="submit" class="w-full p-2 mt-5 bg-custom-orange rounded-sm text-white text-sm font-semibold">Login</button>
            </form>
            <p class="text-sm text-center mt-3">No account yet? <a href="mailto:helpdesk@adish.com.ph" class="text-custom-orange underline">Contact administrator</a>.</p>
        </div>
    </div>
