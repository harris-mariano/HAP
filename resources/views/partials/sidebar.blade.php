...
<div class="flex flex-col gap-y-3 mt-3">
    ...
    <a href="{{ route('tickets.index') }}" class="flex flex-row gap-x-3 items-center p-3 {{ request()->routeIs('tickets.index') || request()->routeIs('tickets.show') ? 'bg-custom-orange rounded-sm text-white' : '' }}">
...
<div class="flex flex-col gap-y-3">
    ...
    <hr class="w-full">
    <a href="{{ route('view.profile') }}" class="flex flex-row gap-x-3 items-center p-3 {{ request()->routeIs('view.profile') ? 'bg-custom-orange rounded-sm text-white' : '' }}">
